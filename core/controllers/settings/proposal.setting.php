...
class SMS_Proposal_Setting extends SevenBaseSettingController {
	var string $context = 'propal';
	var array $errors = [];
	var string $page_name = 'propal_page_title';
	public string $db_key = 'SEVEN_PROPAL_SETTING';
	...
	public function triggerSms(Propal $object, $action): void {
		global $db;
	...
	public function fillKeywordsWithValues(Propal $object, $message): array {
		global $db;
	...
	public function render(): void {
		...
		echo dol_get_fiche_head(sevenAdminPrepareHead(), 'propal', $langs->trans($this->page_name), -1);
