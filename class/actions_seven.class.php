...
class ActionsSeven {
	...
	private SevenActionFactory $sevenActionFactory;
	public string $error = '';
	public array $errors = [];
	...
	public function __construct(public DoliDB $db) {
		...
		$this->sevenActionFactory = new SevenActionFactory;
	}
	...
	public function doActions($parameters, &$object, &$action, $hookmanager) {
		$this->sevenActionFactory->makeActions($parameters, $object, $action, $hookmanager);
	}

	public function addMoreActionsButtons($parameters, &$object, &$action, $hookmanager) {
		$this->sevenActionFactory->makeActionButtons($parameters, $object, $action, $hookmanager);
	}

	public function beforeBodyClose($parameters, &$object, &$action, $hookmanager) {
		$this->sevenActionFactory->makeBeforeBodyClose($parameters, $object, $action, $hookmanager);
	}
