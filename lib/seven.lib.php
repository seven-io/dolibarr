...
function sevenAdminPrepareHead() {
	...
	$head[$h][0] = dol_buildpath("/seven/admin/send_sms.php", 1);
	$head[$h][1] = $langs->trans("SendSMSSettingPageTitle");
	$head[$h][2] = 'send_sms';
	$h++;

	$head[$h][0] = dol_buildpath("/seven/admin/bulk_sms.php", 1);
	...
	$head[$h][0] = dol_buildpath("/seven/admin/contact.php", 1);
	$head[$h][1] = $langs->trans("ContactSettingPageTitle");
	$head[$h][2] = 'contact';
	$h++;

	$head[$h][0] = dol_buildpath("/seven/admin/invoice.php", 1);
	...
	$head[$h][0] = dol_buildpath("/seven/admin/voice_call_logs.php", 1);
